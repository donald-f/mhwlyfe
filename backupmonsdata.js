    ...
    ailments: [
      {
        ...
        name: 'Paralysis',
        description:
          'Paralysis renders the hunter or monster immobilized and susceptible to increased damage for the duration. Hunters can unparalyzed if they are hit.',
        recovery: {
          actions: [],
          items: [],
        },
    ...
    rewards: [
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Sturdy Bone',
          description:
            'A bone used as crafting material. Can be found in bonepiles in the Coral Highlands and Rotten Vale.',
        },
        conditions: [
          {
            type: 'reward',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Monster Bone S',
          description:
            'A material found in bonepiles. Indispensable for both hunting and daily life.',
        },
        conditions: [
          {
            type: 'reward',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Wingdrake Hide',
          description:
            'A material carved from wingdrakes. Lightweight and often used when crafting armor.',
        },
        conditions: [
          {
            type: 'carve',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Barnos Hide+',
          description:
            'Rare Barnos material. Obtained by carving. Supple, used to craft gear.',
        },
        conditions: [
          {
            type: 'carve',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Barnos Talon',
          description:
            'Rare Barnos material. Obtained by carving. Unusual, used in select gear.',
        },
        conditions: [
          {
            type: 'carve',
  ...
  },
  {
    ...
    ailments: [
      ...
      },
      {
        ...
        name: 'Stun',
        description:
          'Stun renders the target inactive, and sometimes causes them to fall over.',
        recovery: {
          actions: [],
          items: [],
        },
  ...
  },
  {
    ...
    ailments: [
      ...
      },
      {
        ...
        name: 'Muddy',
        description:
          'A status effect inflicted when mud thrown by a monster covers the Hunter and makes movement more difficult. Slows all actions until the hunter leaves the mud.',
        recovery: {
          actions: [],
          items: [],
        },
    ...
    rewards: [
      {
        ...
        item: {
          ...
          name: 'Monster Bone M',
          description:
            "Bone obtained from large monsters. Strong yet flexible, it's as reliable as steel or wood.",
        },
        conditions: [
          {
            type: 'reward',
      ...
      },
      {
        ...
        item: {
          ...
          description:
            'Bone obtained from high rank large monsters. It has a razor-sharp tip that retains its strength after forging.',
        },
        conditions: [
          {
            type: 'reward',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Barroth Shell',
          description:
            'Barroth material. Mostly obtained by carving. Broadly used for many purposes.',
        },
        conditions: [
          {
            type: 'track',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Barroth Ridge',
          description:
            'Barroth material. Mostly obtained as a reward. Solid, used to craft gear.',
        },
        conditions: [
          {
            type: 'plunderblade',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Barroth Claw',
          description:
            'Barroth material. Obtained by breaking its forelimbs. Hardy, used in many weapons.',
        },
        conditions: [
          {
            type: 'wound',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Barroth Scalp',
          description:
            'Barroth material. Obtained by breaking its head. Tough, used in many weapons.',
        },
        conditions: [
          {
            type: 'carve',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Barroth Tail',
          description:
            'Barroth material. Obtained by carving its severed tail. Stiff, used to craft gear.',
        },
        conditions: [
          {
            type: 'carve',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Fertile Mud',
          description:
            'Barroth material. Obtained by breaking its mud covering. Unusual, used in select gear.',
        },
        conditions: [
          {
            type: 'shiny',
      ...
      },
      {
        ...
        item: {
          ...
          description:
            'Rare Barroth material. Mostly obtained by carving. Broadly used for many purposes.',
        },
        conditions: [
          {
            type: 'track',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Barroth Ridge+',
          description:
            'Rare Barroth material. Mostly obtained as a reward. Solid, used to craft gear.',
        },
        conditions: [
          {
            type: 'plunderblade',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Barroth Claw+',
          description:
            'Rare Barroth material. Obtained by breaking its forelimbs. Hardy, used in many weapons.',
        },
        conditions: [
          {
            type: 'wound',
    ...
    ailments: [
      {
        ...
        name: 'Fireblight',
        description:
          'Fireblight causes damage over time, and negates regular health recovery.',
        recovery: {
          actions: ['dodge'],
          items: [
            {
    ...
    rewards: [
      {
        ...
        item: {
          ...
          name: 'Monster Bone L',
          description:
            'Bone obtained from large monsters. Hard to work with due to its size, but vital when crafting larger items.',
        },
        conditions: [
          {
            type: 'reward',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Anjanath Pelt',
          description:
            'Anjanath material. Mostly obtained as a reward. Highly heat-resistant, used to craft gear.',
        },
        conditions: [
          {
            type: 'reward',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Anjanath Pelt+',
          description:
            'Rare Anjanath material. Mostly obtained as a reward. Highly heat-resistant, used to craft gear.',
        },
        conditions: [
          {
            type: 'reward',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Anjanath Nosebone+',
          description:
            'Rare Anjanath material. Obtained by breaking its head. Unusual and difficult to handle.',
        },
        conditions: [
          {
            type: 'carve',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Anjanath Gem',
          description:
            'A rare gem said to have formed within Anjanath tissue. Used to dramatically improve gear.',
        },
        conditions: [
          {
            type: 'carve',
    ...
    rewards: [
      {
        ...
        item: {
          ...
          description:
            'Precious bone obtained from high rank large monsters. Their rarity makes them highly sought after.',
        },
        conditions: [
          {
            type: 'reward',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Rath Wingtalon',
          description:
            'Material from Rathian and Rathalos. Obtained by breaking its wings. Sharp, used in many weapons.',
        },
        conditions: [
          {
            type: 'wound',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Rathalos Plate',
          description:
            'Rathalos material. A valuable find, used to fortify gear. Said to be quite hard to come by.',
        },
        conditions: [
          {
            type: 'carve',
      ...
      },
      {
        ...
        item: {
          ...
          description:
            'Rare Rathalos material. Obtained by carving. Grants fire element properties.',
        },
        conditions: [
          {
            type: 'wound',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Rathalos Ruby',
          description:
            'A rare gem said to have formed within Rathalos tissue. Almost too nice to use.',
        },
        conditions: [
          {
            type: 'investigation',
      ...
      },
      {
        ...
        item: {
          ...
          description:
            'Rare Azure Rathalos material. Mostly obtained by carving. Broadly used for many purposes.',
        },
        conditions: [
          {
            type: 'track',
      ...
      },
      {
        ...
        item: {
          ...
          description:
            'Rare Azure Rathalos material. Mostly obtained as a reward. Solid, used to craft gear.',
        },
        conditions: [
          {
            type: 'wound',
      ...
      },
      {
        ...
        item: {
          ...
          description:
            'Rare Azure Rathalos material. Obtained by carving its severed tail. Compatible with fire element.',
        },
        conditions: [
          {
            type: 'carve',
      ...
      },
      {
        ...
        item: {
          ...
          description:
            'Rare Azure Rathalos material. Obtained by breaking its wings. Supple, used to craft gear.',
        },
        conditions: [
          {
            type: 'wound',
    ...
    rewards: [
      ...
      },
      {
        ...
        item: {
          ...
          description:
            'Rare Bazelgeuse material. Mostly obtained by carving. Broadly used for many purposes.',
        },
        conditions: [
          {
            type: 'track',
      ...
      },
      {
        ...
        item: {
          ...
          description:
            'Rare Bazelgeuse material. Mostly obtained as a reward. Solid, used to craft gear.',
        },
        conditions: [
          {
            type: 'wound',
      ...
      },
      {
        ...
        item: {
          ...
          description:
            'Rare Bazelgeuse material. Obtained by carving its severed tail. Stiff, used to craft gear.',
        },
        conditions: [
          {
            type: 'carve',
      ...
      },
      {
        ...
        item: {
          ...
          description:
            'Rare Bazelgeuse material. Obtained by breaking its head. Grants blast element properties.',
        },
        conditions: [
          {
            type: 'wound',
      ...
      },
      {
        ...
        item: {
          ...
          description:
            'Rare Bazelgeuse material. Mostly obtained by carving. Compatible with blast element.',
        },
        conditions: [
          {
            type: 'wound',
      ...
      },
      {
        ...
        item: {
          ...
          description:
            'Rare Bazelgeuse material. Obtained by breaking its wings. Hard, used in many weapons.',
        },
        conditions: [
          {
            type: 'wound',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Bazelgeuse Gem',
          description:
            'A rare gem said to have formed within Bazelgeuse tissue. Used to dramatically improve gear.',
        },
        conditions: [
          {
            type: 'investigation',
    ...
    ailments: [
      {
        ...
        name: 'Bleeding',
        description:
          'Bleeding causes damage when performing certain actions, such as running, dodging, or attacking.',
        recovery: {
          actions: [],
          items: [],
        },
          ...
          items: [
            {
              ...
              description:
                'Provides a moderate boost to your stamina and keeps it at max for a longer period. Meat done right!',
            },
            {
              id: 17,
              rarity: 2,
              ...
              name: 'Astera Jerky',
              description:
                "Juicy, dried meat made by Astera's chef. Boosts natural healing and cures bleeding.",
            },
            {
              id: 107,
              rarity: 2,
              ...
              description:
                'A scale from a Sushifish. Eat to restore a small amount of health. Also works to treat bleeding.',
            },
          ],
        },
      },
    ...
    ailments: [
      {
        ...
        name: 'Dragonblight',
        description:
          "Dragonblight causes your weapon's elemental properties are nullified.",
        recovery: {
          actions: [],
          items: [
            {
    ...
    rewards: [
      {
        ...
        item: {
          ...
          name: 'Dash Extract',
          description:
            'A mysterious substance culled from certain monsters that increases endurance.',
        },
        conditions: [
          {
            type: 'reward',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Diablos Shell',
          description:
            'Diablos material. Mostly obtained by carving. Broadly used for many purposes.',
        },
        conditions: [
          {
            type: 'track',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Diablos Ridge',
          description:
            'Diablos material. Mostly obtained as a reward. Solid, used to craft gear.',
        },
        conditions: [
          {
            type: 'wound',
      ...
      },
      {
        ...
        item: {
          ...
          description:
            'Diablos material. Obtained by carving its severed tail. Sturdy, but difficult to handle.',
        },
        conditions: [
          {
            type: 'carve',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Diablos Fang',
          description:
            'Diablos material. Mostly obtained by carving. Sharp, used in many weapons.',
        },
        conditions: [
          {
            type: 'plunderblade',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Twisted Horn',
          description:
            'Diablos material. Obtained by breaking its horns. Stout, used in many weapons.',
        },
        conditions: [
          {
            type: 'wound',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Diablos Marrow',
          description:
            'Diablos material. A valuable find, used to fortify gear. Said to be quite hard to come by.',
        },
        conditions: [
          {
            type: 'wound',
      ...
      },
      {
        ...
        item: {
          ...
          description:
            'Rare Diablos material. Mostly obtained by carving. Broadly used for many purposes.',
        },
        conditions: [
          {
            type: 'track',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Diablos Ridge+',
          description:
            'Rare Diablos material. Mostly obtained as a reward. Solid, used to craft gear.',
        },
        conditions: [
          {
            type: 'wound',
    ...
    rewards: [
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Blos Medulla',
          description:
            'Rare Diablos material. A valuable find, used to fortify gear. Said to be quite hard to come by.',
        },
        conditions: [
          {
            type: 'wound',
      ...
      },
      {
        ...
        item: {
          ...
          description:
            'Rare Black Diablos material. Mostly obtained by carving. Broadly used for many purposes.',
        },
        conditions: [
          {
            type: 'track',
      ...
      },
      {
        ...
        item: {
          ...
          description:
            'Rare Black Diablos material. Mostly obtained as a reward. Solid, used to craft gear.',
        },
        conditions: [
          {
            type: 'wound',
      ...
      },
      {
        ...
        item: {
          ...
          description:
            'Rare Black Diablos material. Obtained by breaking its horns. Stout, used in many weapons.',
        },
        conditions: [
          {
            type: 'wound',
    ...
    rewards: [
      {
        ...
        item: {
          ...
          description:
            'Can be obtained from certain large monsters. Has the ability to amplify the effects of certain medicines.',
        },
        conditions: [
          {
            type: 'reward',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Dodogama Scale+',
          description:
            'Rare Dodogama material. Mostly obtained by carving. Broadly used for many purposes.',
        },
        conditions: [
          {
            type: 'carve',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Dodogama Hide+',
          description:
            'Rare Dodogama material. Mostly obtained as a reward. Supple, used to craft gear.',
        },
        conditions: [
          {
            type: 'carve',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Dodogama Jaw',
          description:
            'Rare Dodogama material. Obtained by breaking its head. Unusual and difficult to handle.',
        },
        conditions: [
          {
            type: 'wound',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Dodogama Talon',
          description:
            'Rare Dodogama material. Obtained by breaking its forelegs. Heavy, used to craft armor.',
        },
        conditions: [
          {
            type: 'wound',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Dodogama Tail',
          description:
            'Rare Dodogama material. Obtained by carving its severed tail. Tough, used in many weapons.',
        },
        conditions: [
          {
            type: 'carve',
    ...
    rewards: [
      ...
      },
      {
        ...
        item: {
          ...
          description:
            'A bone from an elder dragon. It exudes the great majesty of the beast that bore it.',
        },
        conditions: [
          {
            type: 'reward',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Kirin Hide',
          description:
            'Kirin material. Mostly obtained by carving. Broadly used for many purposes.',
        },
        conditions: [
          {
            type: 'track',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Kirin Tail',
          description:
            'Kirin material. Mostly obtained as a reward. Compatible with thunder element.',
        },
        conditions: [
          {
            type: 'plunderblade',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Kirin Mane',
          description:
            'Kirin material. Mostly obtained by carving. Highly thunder-resistant, used to craft gear.',
        },
        conditions: [
          {
            type: 'reward',
      ...
      },
      {
        ...
        item: {
          ...
          description:
            'Kirin material. Obtain by breaking its horn. Grants thunder element properties.',
        },
        conditions: [
          {
            type: 'wound',
      ...
      },
      {
        ...
        item: {
          ...
          name: 'Kirin Hide+',
          description:
            'Rare Kirin material. Mostly obtained by carving. Broadly used for many purposes.',
        },
        conditions: [
          {
            type: 'track',
      ...
      },
      {
        ...
        item: {
          ...
          description:
            'Rare Kirin material. Mostly obtained as a reward. Compatible with thunder element.',
        },
        conditions: [
          {
            type: 'carve',
      ...
      },
      {
        ...
        item: {
          ...
          description:
            'Rare Kirin material. Obtain by breaking its horn. Grants thunder element properties.',
        },
        conditions: [
          {
            type: 'wound',
    ...
    ailments: [
      {
        ...
        name: 'Iceblight',
        description:
          'Iceblight causes stamina usage to increase when performing actions.',
        recovery: {
          actions: [],
          items: [
            {
    ...
    ailments: [
      {
        ...
        name: 'Wind Pressure',
        description:
          'Wind pressure causes the hunter to brace against powerful winds, causing temporarily imobility.',
        recovery: {
          actions: [],
          items: [],
        },
          ...
          items: [
            {
              ...
              name: 'Energy Drink',
              description:
                'A Guild-approved beverage that boosts your stamina. Helps shake off sleep, too!',
            },
          ],
        },
      },
    ...
    ailments: [
      {
        ...
        description:
          'Effluvial buildup causes damage over time, and eventually cuts your maximum health in half if ignored for too long.',
        recovery: {
          actions: [],
          items: [
            {
          ...
          skills: [
            {
              ...
              description:
                'Nullifies or reduces environmental damage in the Rotten Vale.',
            },
            {
              id: 101,
